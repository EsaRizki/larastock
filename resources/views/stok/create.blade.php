        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-solid box-primary">
                    <div class="box-header with-border">
                        <h2 class="box-title">Tambah Stok {{ $barang->nama }}</h2>
                ...
                <div class="box-body">
                  <form method="POST" id="myForm" action="{{ route('stok.store') }}" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" value="{{ $barang->stoks->last()->sisa }}" name="sisa">
                                    <div class="form-group row">
                                        <label for="qty" class="col-md-offset-2 col-md-2 control-label col-form-label text-md-right">{{ __('Jumlah') }}</label>

                                        <div class="col-md-6">
                                            <input id="qty" type="number" class="form-control @error('qty') is-invalid @enderror" name="qty" required autocomplete="qty" autofocus>
