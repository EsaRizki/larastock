    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-solid box-primary">
                ...
                <div class="box-body">
                  <form method="POST" id="myForm" action="{{ route('harga.update',['barang'=>$barang->id,'area'=>$area->id]) }}" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="harga" type="number" class="form-control @error('harga') is-invalid @enderror" name="harga" required autocomplete="harga" value="{{ old('harga', $barang->areas->find($area)->pivot->harga) }}" autofocus>
